...
class protlist extends StatefulWidget {
  const protlist({super.key});

  @override
  State<protlist> createState() => _protlistState();
}

class _protlistState extends State<protlist> {
  ...
  List<int> price = [100, 150, 180, 200, 250, 300];
  List<String> image = [
    "images/cake.jpg",
    "images/happy-birthday-cake-topper.webp",
    "images/Hazelnut-Ganache-Tart_thumbnail.jpg",
    "images/1-7.jpg",
    "images/grasshopper-ice-cream-tart-3-1.jpg",
    "images/torta.jpg",
  ];
